...
var op_selectTXT = ["MUSIC:", "ON", "OFF", "SCALE:", "5 * 5", "10 * 10", "15 * 15", "DIFFICULTY:", "EASY", "MID", "HARD", "Back To Main Menu"];
...
function updateOpPage(Index) {
    ...
    context.arcTo(960, 110, 960, 470, 30);
    context.arcTo(960, 470, 40, 470, 30);
    context.arcTo(40, 470, 40, 110, 30);
